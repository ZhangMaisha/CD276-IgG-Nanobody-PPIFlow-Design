...
- `results/md_analysis/primary_0_50ns/`: primary reported MD summary, figure subdirectories (`combined/`, `antibody/`, `nanobody/`), and raw XVG analysis files
...
- `results/md_analysis/primary_0_50ns/`: primary MD result directory containing summary tables, combined/per-system figures, and raw XVG analysis files
